...
mixin _$RoomSession {
 ...
 String get roomId; String get roomName; RoomStatus get status; List<RoomMemberModel> get members; String get getstreamCallId; String? get sessionId; bool get isInCall; bool get isEnded; bool get isHost; bool get isHostDisconnected; int get hostGraceSeconds;
...
@override
int get hashCode => Object.hash(runtimeType,roomId,roomName,status,const DeepCollectionEquality().hash(members),getstreamCallId,sessionId,isInCall,isEnded,isHost,isHostDisconnected,hostGraceSeconds);

@override
String toString() {
  return 'RoomSession(roomId: $roomId, roomName: $roomName, status: $status, members: $members, getstreamCallId: $getstreamCallId, sessionId: $sessionId, isInCall: $isInCall, isEnded: $isEnded, isHost: $isHost, isHostDisconnected: $isHostDisconnected, hostGraceSeconds: $hostGraceSeconds)';
}
...
@useResult
$Res call({
 String roomId, String roomName, RoomStatus status, List<RoomMemberModel> members, String getstreamCallId, String? sessionId, bool isInCall, bool isEnded, bool isHost, bool isHostDisconnected, int hostGraceSeconds
});
...
/// Create a copy of RoomSession
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? roomId = null,Object? roomName = null,Object? status = null,Object? members = null,Object? getstreamCallId = null,Object? sessionId = freezed,Object? isInCall = null,Object? isEnded = null,Object? isHost = null,Object? isHostDisconnected = null,Object? hostGraceSeconds = null,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String roomId,  String roomName,  RoomStatus status,  List<RoomMemberModel> members,  String getstreamCallId,  String? sessionId,  bool isInCall,  bool isEnded,  bool isHost,  bool isHostDisconnected,  int hostGraceSeconds)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _RoomSession() when $default != null:
return $default(_that.roomId,_that.roomName,_that.status,_that.members,_that.getstreamCallId,_that.sessionId,_that.isInCall,_that.isEnded,_that.isHost,_that.isHostDisconnected,_that.hostGraceSeconds);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String roomId,  String roomName,  RoomStatus status,  List<RoomMemberModel> members,  String getstreamCallId,  String? sessionId,  bool isInCall,  bool isEnded,  bool isHost,  bool isHostDisconnected,  int hostGraceSeconds)  $default,) {final _that = this;
switch (_that) {
case _RoomSession():
return $default(_that.roomId,_that.roomName,_that.status,_that.members,_that.getstreamCallId,_that.sessionId,_that.isInCall,_that.isEnded,_that.isHost,_that.isHostDisconnected,_that.hostGraceSeconds);case _:
  throw StateError('Unexpected subclass');
...
class _RoomSession implements RoomSession {
  const _RoomSession({required this.roomId, required this.roomName, required this.status, required final  List<RoomMemberModel> members, required this.getstreamCallId, this.sessionId, this.isInCall = false, this.isEnded = false, this.isHost = false, this.isHostDisconnected = false, this.hostGraceSeconds = 0}): _members = members;
...
@override
int get hashCode => Object.hash(runtimeType,roomId,roomName,status,const DeepCollectionEquality().hash(_members),getstreamCallId,sessionId,isInCall,isEnded,isHost,isHostDisconnected,hostGraceSeconds);
...
/// Create a copy of RoomSession
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? roomId = null,Object? roomName = null,Object? status = null,Object? members = null,Object? getstreamCallId = null,Object? sessionId = freezed,Object? isInCall = null,Object? isEnded = null,Object? isHost = null,Object? isHostDisconnected = null,Object? hostGraceSeconds = null,}) {
